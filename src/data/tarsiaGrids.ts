...
// Из репозитория PeterGrahamJersey/tarsia-generator — smallTriangleGrid.js
// 9 треугольников, 9 пар (6 внутренних + 3 внешних вопроса)
...
// Из репозитория — triangleGrid.js (большой треугольник, 18 пар)
export const triangleGrid: TarsiaGridConfig = {
  id: 'triangle',
  name: 'Большая треугольная',
  description: '18 пар, классическая форма',
  questionCount: 18,
  triangles: [
...
// Из репозитория — smallHexGrid.js (маленький шестиугольник, 10 пар)
export const smallHexGrid: TarsiaGridConfig = {
  id: 'small-hex',
  name: 'Маленькая шестиугольная',
  description: '10 пар, компактные соты',
  questionCount: 10,
  triangles: [
    { row: 1, col: 4, values: ['1q', null, null] },
    { row: 2, col: 3, values: ['4q', '2q', null] },
...
// Из репозитория — hexGrid.js (большой шестиугольник, 30 пар)
export const hexGrid: TarsiaGridConfig = {
  id: 'hex',
  name: 'Большая шестиугольная',
  description: '30 пар, большие соты',
  questionCount: 30,
  triangles: [
    { row: 1, col: 2, values: ['5q', '1q', null] },
    { row: 1, col: 3, values: [null, '1a', '2q'] },
