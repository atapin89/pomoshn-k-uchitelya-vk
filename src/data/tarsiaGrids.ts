...
export const smallTriangleGrid: TarsiaGridConfig = {
  ...
  description: '6 пар, компактная сетка',
  questionCount: 6,
  triangles: [
    ...
    { row: 3, col: 2, values: ['3a', '6q', null] },
    { row: 3, col: 3, values: ['6a', '5a', null] },
  ],
};
...
export const triangleGrid: TarsiaGridConfig = {
  ...
  description: '18 пар, классическая сетка',
  questionCount: 18,
  triangles: [
...
export const smallHexGrid: TarsiaGridConfig = {
  ...
  description: '6 пар, шестиугольная форма',
  questionCount: 6,
  triangles: [
...
export const hexGrid: TarsiaGridConfig = {
  ...
  description: '12 пар, шестиугольная форма',
  questionCount: 12,
  triangles: [
...
export function getTarsiaGridById(id: string): TarsiaGridConfig {
  return TARSIAG_GRIDS.find((g) => g.id === id) || triangleGrid;
}
