...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    hint: 'Конструктор карточек с настраиваемыми параметрами: размер сетки, количество карточек, свободная клетка. Готовые наборы, режим проектора, PDF для печати.',
    icon: LayoutGrid,
  },
  {
    id: 'edugame',
    ...
    hint: 'Интеллектуальная викторина по принципу телевизионной «Своей игры»: режим разработчика, проектор с табло, рейтинг участников, печать карточек, обмен играми.',
    icon: Trophy,
  },
  {
    id: 'activity',
